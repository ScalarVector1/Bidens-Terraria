...
namespace BidenMod.Helpers
{
	internal static class GUIHelper
	{
		/// <summary>
		/// Draws a simple box in the style of the BidenMod GUI.
		/// </summary>
		...
		{
			Texture2D tex = ModContent.Request<Texture2D>("BidenMod/Assets/GUI/Box").Value;
		...
		/// <summary>
		/// Gets the inverse of a color. Used for 'constrasting' elements of the BidenMod GUI, such as outlines indicating something being on.
		/// </summary>
		...
		public static void OpenConfig(ModConfig config)
		{
			...
			setMod.Invoke(ui, new object[] { ModContent.GetInstance<BidenMod>(), config });
